...
const NavbarLinks = ({ desktop }) => {
  ...
  return (
    <Wrapper desktop={desktop} theme={theme}>
      ...
      <li></li><a href="#oktatas" ref={React.createRef()} duration="400ms"
   >Oktatás</a>
      <li></li><a href="#about" ref={React.createRef()} duration="400ms"
   >Rólunk</a>
      <li></li><a href="#tanuloink" ref={React.createRef()} duration="400ms"
   >Tanulóink</a>
      <li></li><a href="#contact" ref={React.createRef()} duration="400ms"
   >Kapcsolat</a>
   </Scrollspy>
      <ToggleTheme />
    </Wrapper>
