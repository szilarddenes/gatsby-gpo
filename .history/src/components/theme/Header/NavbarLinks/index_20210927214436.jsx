...
const NavbarLinks = ({ desktop }) => {
  ...
  return (
    <Wrapper desktop={desktop} theme={theme}>
      <ScrollSpy>
      <a href="#oktatas" ref={React.createRef()} duration="200ms"
   >Oktatás</a>
      <a href="#about" ref={React.createRef()} duration="200ms"
   >Rólunk</a>
      <a href="#tanuloink" ref={React.createRef()} duration="200ms"
   >Tanulóink</a>
      <a href="#contact" ref={React.createRef()} duration="200ms"
   >Kapcsolat</a>
   </ScrollSpy>
      <ToggleTheme />
    </Wrapper>
