...
const NavbarLinks = ({ desktop }) => {
  ...
  return (
    <Wrapper desktop={desktop} theme={theme}>
      <ScrollSpy>
      <a href="#oktatas" ref={React.createRef() duration="400"}
   >Oktatás</a>
      <a href="#about" ref={React.createRef() duration="400"}
   >Rólunk</a>
      <a href="#tanuloink" ref={React.createRef() duration="400"}
   >Tanulóink</a>
      <a href="#contact" ref={React.createRef() duration="400"}
   >Kapcsolat</a>
   </ScrollSpy>
      <ToggleTheme />
    </Wrapper>
