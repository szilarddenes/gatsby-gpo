...
const NavbarLinks = ({ desktop }) => {
  ...
  return (
    <Wrapper desktop={desktop} theme={theme}>
      <ScrollSpy>
      <a href="#oktatas" ref={React.createRef()} duration="2500ms"
   >Oktatás</a>
      <a href="#about" ref={React.createRef()} duration="2500ms"
   >Rólunk</a>
      <a href="#tanuloink" ref={React.createRef()} duration="2500ms"
   >Tanulóink</a>
      <a href="#contact" ref={React.createRef()} duration="2500ms"
   >Kapcsolat</a>
   </ScrollSpy>
      <ToggleTheme />
    </Wrapper>
