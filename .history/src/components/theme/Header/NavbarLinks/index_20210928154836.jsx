...
<ScrollNav selector="a">
        <a href="" data-scrollspy-id="oktatas">okt</a>
        <a href="" data-scrollspy-id="about">ab</a>
        <a href="" data-scrollspy-id="tanuloink">tan</a>
        <a href="" data-scrollspy-id="contact">cont</a>
