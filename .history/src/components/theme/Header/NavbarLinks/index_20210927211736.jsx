...
const NavbarLinks = ({ desktop }) => {
  ...
  return (
    <Wrapper desktop={desktop} theme={theme}>
      <ScrollSpy>
      <a href="#oktatas" ref={React.createRef() duration=""}
   >Oktatás</a>
      <a href="#about" ref={React.createRef() duration=""}
   >Rólunk</a>
      <a href="#tanuloink" ref={React.createRef() duration=""}
   >Tanulóink</a>
      <a href="#contact" ref={React.createRef() duration=""}
   >Kapcsolat</a>
   </ScrollSpy>
      <ToggleTheme />
    </Wrapper>
