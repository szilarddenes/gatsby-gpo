...
import React, { useContext, re } from "react"
import { ThemeContext } from "providers/ThemeProvider"
import ToggleTheme from "components/theme/Header/ToggleTheme"
import { Wrapper } from "./styles"
...
const NavbarLinks = ({ desktop }) => {
  ...
  return (
    <Wrapper desktop={desktop} theme={theme}>
      <ScrollSpy>
        <a href="#oktatas" ref={React.createRef()} duration="250ms" >
          Oktatás
        </a>
        <a href="#about" ref={React.createRef()} duration="250ms">
          Rólunk
        </a>
        <a href="#tanuloink" ref={React.createRef()} duration="250ms">
          Tanulóink
        </a>
        <a href="#contact" ref={React.createRef()} duration="250ms">
          Kapcsolat
        </a>
      </ScrollSpy>
      <ToggleTheme />
