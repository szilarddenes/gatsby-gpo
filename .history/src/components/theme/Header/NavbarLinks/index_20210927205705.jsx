...
const NavbarLinks = ({ desktop }) => {
  ...
  return (
    <Wrapper desktop={desktop} theme={theme}>
      <a to="oktatas" activeClass="active"
    
    duration={500} smooth={true} >Oktatás</a>
      <a to="about" activeClass="active"
    
    duration={500} smooth={true} >Rólunk</a>
      <a to="tanuloink" activeClass="active"
    
    duration={500} smooth={true} >Tanulóink</a>
      <a to="contact" activeClass="active"
    
    duration={500} smooth={true} >Kapcsolat</a>
      <ToggleTheme />
    </Wrapper>
  )
