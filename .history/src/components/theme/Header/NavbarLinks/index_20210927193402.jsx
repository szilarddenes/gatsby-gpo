...
const NavbarLinks = ({ desktop }) => {
  ...
  return (
    ...
    duration={500} smooth={true} spy={false}>Oktatás</Link>
      <Link to="about" activeClass="active"
    
    duration={500} smooth={true} spy={false}>Rólunk</Link>
      <Link to="tanuloink" activeClass="active"
    
    duration={500} smooth={true} spy={false}>Tanulóink</Link>
      <Link to="contact" activeClass="active"
    
    duration={500} smooth={true} spy={false}>Kapcsolat</Link>
      <ToggleTheme />
    </Wrapper>
  )
