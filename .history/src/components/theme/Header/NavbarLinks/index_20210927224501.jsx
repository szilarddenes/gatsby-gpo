...
<FancyButton href="#oktatas" text="Oktatás" ref={createRef()} />
<FancyButton href="#about" text="Rólunk" ref={createRef()} />
<FancyButton href="#tanuloink" text="Tanulóink" ref={createRef()} />
<FancyButton href="#contact" text="Kapcsolat" ref={createRef()} />
      </ScrollSpy>
      <ToggleTheme />
    </Wrapper>
  )
