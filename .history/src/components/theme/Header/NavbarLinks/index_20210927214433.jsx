...
const NavbarLinks = ({ desktop }) => {
  ...
  return (
    <Wrapper desktop={desktop} theme={theme}>
      <ScrollSpy>
      <a href="#oktatas" ref={React.createRef()} duration="00ms"
   >Oktatás</a>
      <a href="#about" ref={React.createRef()} duration="00ms"
   >Rólunk</a>
      <a href="#tanuloink" ref={React.createRef()} duration="00ms"
   >Tanulóink</a>
      <a href="#contact" ref={React.createRef()} duration="00ms"
   >Kapcsolat</a>
   </ScrollSpy>
      <ToggleTheme />
    </Wrapper>
