...
<ScrollNav selector="a">
        <a href="#oktatas" data-scrollspy-id="oktatas">okt</a>
        <a href="about" data-scrollspy-id="about">ab</a>
        <a href="tanuloink" data-scrollspy-id="tanuloink">tan</a>
        <a href="contact" data-scrollspy-id="contact">cont</a>
