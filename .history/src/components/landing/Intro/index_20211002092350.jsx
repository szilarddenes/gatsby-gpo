...
import { Thumbnail, BorderedImage, Details, Wrapper, IntroWrapper, BckgImgStyle,BackgroundContainer } from "./styles";
  ...
  return (
    ...
    <Wrapper>
      ...
      <pre style={{overflow:'hidden', wordWrap:'break-word'}}>
        ...
        git commit -m 'hero image as BackgroundImage from gatsby. contained, not looking '
