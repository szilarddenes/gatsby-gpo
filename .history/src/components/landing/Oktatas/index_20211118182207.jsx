...
import { Container, Card, CardHead, CardBody,CardSvg, TitleWrap, ItemA } from 'components/common';
  ...
  return (
    <Wrapper as={Container} id="oktatas" >
      ...
      <Grid>
        ...
        {nodes.map(( item ) => (
          <Item key={item.id}  href={item.url} target="_blank" rel="noopener noreferrer" theme={theme} as={Item}>
            <Card theme={theme} 
