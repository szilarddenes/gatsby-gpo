...
import { Container, Card, CardHead, CardBody, TitleWrap } from 'components/common';
      ...
      <Grid>
        ...
        {nodes.map(( item ) => (
          <Item key={item.id} as="a" href={item.url} target="_blank" rel="noopener noreferrer" theme={theme}>
            <Card theme={theme} >
              <div style={{backgroundImage:`${item.background}`,  backgroundRepeat: 'no-repeat', backgroundSize:'cover', minHeight:'33%', minWidth:'100%'}} >
