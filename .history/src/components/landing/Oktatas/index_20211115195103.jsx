...
const Oktatas = () => {
  ...
  return (
    ...
    <div class="card">
		<div class="card__icon" style={{backgroundImage:`${item.background}`,  backgroundRepeat: 'no-repeat', backgroundSize:'contain', minHeight:'33%',height:'100%', minWidth:'100%', width:'100%'}}   ><i class="fas fa-money-check-alt fa-4x"></i></div>
