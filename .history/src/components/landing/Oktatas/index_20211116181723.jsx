      ...
      <Grid>
        ...
        {nodes.map(( item ) => (
          <Item key={item.id}  href={item.url} target="_blank" rel="noopener noreferrer" theme={theme}>
            ...
            >
              <div as = CardHead style={{backgroundImage:`${item.background}`,  backgroundRepeat: 'no-repeat', backgroundSize:'contain', minHeight:'33%', minWidth:'100%', width:'100%',height:'100%'}} >
