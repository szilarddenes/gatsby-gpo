...
import Popup from "components/common/GDPR/Popup"
        ...
        render={({ handleSubmit, form, submitting, pristine, values }) => (
          <form onSubmit={handleSubmit} theme={theme}>
            ...
            <Center>
              ...
              <br />
              <small>*Az Elküldöm gomb megnyomásával kijelentem, hogy megismertem és elfogadom az <a href="#" onClick={togglePopup}> Adatkezelési tájékoztatót.</a> </small>
              {isOpen && (
                <Popup
