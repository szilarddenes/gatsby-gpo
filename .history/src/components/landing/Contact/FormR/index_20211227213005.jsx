        ...
        render={({ handleSubmit, form, submitting, pristine, values }) => (
          <form onSubmit={handleSubmit} theme={theme}>
            ...
            <Center>
              ...
              <br />
              <small>*Az Elküldöm gomb megnyomásával kijelentem, hogy megismertem és elfogadom az 
             <div></div> id="linkHighlight"
              <a onClick={togglePopup} theme={theme}> Adatkezelési tájékoztatót.</a> 
