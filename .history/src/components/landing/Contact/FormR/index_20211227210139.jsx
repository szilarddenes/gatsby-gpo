import React, { useContext, const [state, setstate] = useState(initialState) } from "react"
import { Form, Field } from "react-final-form"
import { FormStyles, Center, Error } from "../styles"
import { Button } from "components/common"
import { ThemeContext } from "providers/ThemeProvider"
import Popup from 'Theme/Footer/Popup.jsx'
        ...
        render={({ handleSubmit, form, submitting, pristine, values }) => (
          <form onSubmit={handleSubmit} theme={theme}>
            ...
            <Center>
              ...
              <br />
              <small>*Az Elküldöm gomb megnyomásával kijelentem, hogy megismertem és elfogadom az <a onClick={togglePopup}> Adatkezelési tájékoztatót.</a></small>
            </Center>
