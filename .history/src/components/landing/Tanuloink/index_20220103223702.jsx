    ...
    <Wrapper as={Container} id="tanuloink" >
      ...
      <TanuloinkWrapper>
        <Details theme={theme} >
          <div className="detailsCont">
            <p> 
              Udvarhelyi irodánk megnyitása óta több mint 300-an választották képzéseinket, néhányukkal itt is megismerkedhettek. Sikeres vizsgázóinkról, az iskolánkat éríntő újdonságokról beszámolunk a közösségi felületeinken is, kövessetek minket <b>
              <a
