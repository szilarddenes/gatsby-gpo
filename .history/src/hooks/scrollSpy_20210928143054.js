...
ReactDOM.render(React.createElement(Scrollspy, { ids: ["One", "Two", "Three", "Four"], itemContainerClassName: "scrollSpyContainer", activeItemClassName: "active", itemClassName: "spyItemClass" }), document.getElementById('scrollspy'));
