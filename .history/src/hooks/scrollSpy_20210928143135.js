...
ReactDOM.render(React.createElement(Scrollspy, { ids: ["oktatas", "Two", "Three", "Four"], itemContainerClassName: "scrollSpyContainer", activeItemClassName: "active", itemClassName: "spyItemClass" }), document.getElementById('scrollspy'));
