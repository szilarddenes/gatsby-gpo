...
ReactDOM.render(React.createElement(Scrollspy, { ids: ["oktatas", "about", "Three", "Four"], itemContainerClassName: "scrollSpyContainer", activeItemClassName: "active", itemClassName: "spyItemClass" }), document.getElementById('scrollspy'));
