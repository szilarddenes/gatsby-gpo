...
class Scrollspy extends React.Component {
    ...
    render() {
        ...
        return (React.createElement("div", { className: classNames(itemContainerClassName) }, this.state.items.map((item, k) => {
            return (React.createElement("a", { className: classNames(itemClassName, item.inView ? activeItemClassName : null), key: k, onClick: () => {
