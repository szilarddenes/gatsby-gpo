...
ReactDOM.render(React.createElement(Scrollspy, { ids: ["oktatas", "about", "tanuloink", "Four"], itemContainerClassName: "scrollSpyContainer", activeItemClassName: "active", itemClassName: "spyItemClass" }), document.getElementById('scrollspy'));
