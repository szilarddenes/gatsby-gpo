import {React, ReactDOM, ReactElement, classNames} from "react"
...
export ReactDOM.render(React.createElement(Scrollspy, { ids: ["oktatas", "about", "tanuloink", "contact"], itemContainerClassName: "scrollSpyContainer", activeItemClassName: "active", itemClassName: "spyItemClass" }), document.getElementById('scrollspy'));
