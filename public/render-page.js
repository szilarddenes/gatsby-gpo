...
var plugins = [{
  ...
  options: {
    "plugins": [],
    "name": "#GPO autósiskola - Székelyudvarhely",
    "short_name": "gpoauto",
    "start_url": "/",
    "display": "minimal-ui",
    ...
    "cacheDigest": "42454488875265cab51e8ac5fc4a6d9a"
  }
}, {
  ...
  options: {
    "plugins": [],
    "trackingIds": ["G-MESRNJJ1QV"],
    "gtagConfig": {
      "optimize_id": "G-MESRNJJ1QV",
      "anonymize_ip": true,
      "cookie_expires": 0
    },
    "pluginConfig": {
...
var wrapRootElement = function wrapRootElement(_ref) {
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(providers_ThemeProvider__WEBPACK_IMPORTED_MODULE_1__["default"], null, element);
};
...
var useDarkMode = function useDarkMode() {
  ...
  var prefersDarkMode = (0,hooks_useMedia__WEBPACK_IMPORTED_MODULE_1__["default"])(['(prefers-color-scheme: dark)'], [true], false);
...
var ThemeContext = /*#__PURE__*/(0,react__WEBPACK_IMPORTED_MODULE_0__.createContext)("light");

var ThemeProvider = function ThemeProvider(_ref) {
  var children = _ref.children;

  var _useDarkMode = (0,hooks_useDarkMode__WEBPACK_IMPORTED_MODULE_1__["default"])(),
      theme = _useDarkMode[0],
      toggleTheme = _useDarkMode[1];
